...
const PrivacyPolicy = () => {
  return (
    <>
      <Helmet>
        <title>Privacy Policy - Laptop Connect</title>
        <meta name="description" content="Read Laptop Connect's privacy policy to understand how we collect, use, and protect your personal information when you use our website and services." />
        <meta name="keywords" content="privacy policy, data protection, laptop connect privacy, personal information" />
        <link rel="canonical" href="https://laptopconnect.com/privacy" />
      </Helmet>
      ...
      <div className="container px-4 py-8 md:px-6 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <ul className="list-disc pl-6 mb-4">
            ...
            <li>Google Sheets for inventory management</li>
          </ul>
          <p className="mb-4">
