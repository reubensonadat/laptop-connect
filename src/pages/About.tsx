...
const About = () => {
  return (
    <>
      <Helmet>
        <title>About Us - Laptop Connect | Your Trusted Laptop Partner in Ghana</title>
        <meta name="description" content="Learn about Laptop Connect, Ghana's premier destination for quality laptops tailored to academic needs. Our mission is to help students and professionals find the perfect laptop." />
        <meta name="keywords" content="about laptop connect, laptop ghana, laptop store accra, about us, laptop shop ghana, student laptops ghana" />
        <link rel="canonical" href="https://laptopconnect.com/about" />
      </Helmet>
