...
const About = () => {
  ...
  const aboutStructuredData = {
    ...
    "url": "https://www.laptopconnect.shop/about",
    "mainEntity": {
      "@type": "Organization",
      "name": "Laptop Connect",
      "foundingDate": "2025",
      "description": "Your trusted partner for quality laptops in Ghana",
      "address": {
        "@type": "PostalAddress",
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
        {/* Hero Section */}
        <header className="relative bg-gradient-to-r from-primary-blue to-blue-600 text-white py-20">
