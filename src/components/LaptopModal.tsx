...
const LaptopModal: React.FC<LaptopModalProps> = ({ laptop, onClose }) => {
  ...
  const structuredData = {
    ...
    "image": imageUrl || '',
    "description": laptop.description || `${laptop.brand} ${laptop.model} with ${laptop.processor}, ${laptop.ram} RAM, ${laptop.storage}`,
    "brand": {
      "@type": "Brand",
      "name": laptop.brand
    },
  ...
  return (
    <>
      <Helmet>
        <title>{`${laptop.brand} ${laptop.model} - Laptop Connect`}</title>
        <meta name="description" content={`${laptop.brand} ${laptop.model} with ${laptop.processor}, ${laptop.ram} RAM, ${laptop.storage}. ${laptop.description || `Quality ${laptop.condition} laptop at ${formatPrice(laptop.price)}.`}`} />
        <meta name="keywords" content={`${laptop.brand}, ${laptop.model}, ${laptop.processor}, ${laptop.ram}, ${laptop.storage}, laptop ghana, laptop accra, ${laptop.condition} laptop`} />
